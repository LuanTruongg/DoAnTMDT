...
<div class="category-flex" id="product">
		<div class="category-container-flex">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<label>
					<span>Hảng</span>
					<input type="text" name="hang_san_pham" placeholder="Hảng sản phẩm" class="form-product-input" required>
				</label>
				<label>
					<span>Số lượng</span>
...
<!-- ------------------------------------ Update San Pham --------------------------------------- -->
		<div class="category-container">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<label>
					<span>Hảng</span>
					<input type="text" name="hang_san_pham" placeholder="Hảng sản phẩm" class="form-product-input" value="<?php echo $row_capnhat_sp['sanpham_brand'] ?>">
				</label>
				<label>
					<span>Số lượng</span>
